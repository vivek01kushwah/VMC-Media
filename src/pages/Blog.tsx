...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title="Blog | VMC Media Pvt. Ltd."
        description="Stay updated with the latest trends, tips, and insights in digital marketing and SEO from VMC Media experts."
        canonical="/blog"
      />
      <Header />
        ...
        <div className="container mx-auto px-6 lg:px-8 max-w-7xl">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <div
                key={index}
                className="group overflow-hidden rounded-lg border border-border bg-card hover:shadow-xl transition-all duration-300 animate-fade-in flex flex-col"
